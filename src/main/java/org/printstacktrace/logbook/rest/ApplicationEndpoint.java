...
public class ApplicationEndpoint {
	...
	return Response.created(
		UriBuilder.fromResource(ApplicationEndpoint.class)
	...
	TypedQuery<Application> findByIdQuery = em
		.createQuery(
			"SELECT a FROM Application a LEFT JOIN FETCH a.servers WHERE a.id = :entityId",
			Application.class);
	...
	final List<Application> results = em.createQuery(
		"SELECT a FROM Application a LEFT JOIN FETCH a.servers",
