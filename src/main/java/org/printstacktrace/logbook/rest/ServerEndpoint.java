...
public class ServerEndpoint {
	...
	return Response.created(
		UriBuilder.fromResource(ServerEndpoint.class)
	...
	TypedQuery<Server> findByIdQuery = em.createQuery(
		"SELECT s FROM Server s WHERE s.id = :entityId", Server.class);
	...
	final List<Server> results = em.createQuery("SELECT s FROM Server s",
